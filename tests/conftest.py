...
#     return lambda: SqlAlchemyRepository(Maker, get_session())


# @pytest.fixture
# def get_uow(get_session: SessionMaker) -> Callable[[], AbstractUnitOfWork[Maker]]:
#     return lambda: SqlAlchemyUnitOfWork(Maker, get_session)
